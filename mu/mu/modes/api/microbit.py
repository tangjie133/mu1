...
MICROBIT_APIS = [
    ...
    # robotbit
    _("robotbit.motor(index, speed, duration) \nSet speed for dc motor\nindex: 0 for all motors, 1~4 indicate M1A,M1B,M2A,M2B\nduration: milliseconds to stop, 0 for none stopping"),
    _("robotbit.motorstop(index) \nStop dc motor\nindex: 0 for all motors, 1~4 indicate M1A,M1B,M2A,M2B"),
    _("robotbit.stepper(degree1, degree2) \nmove degree of 28BYJ steppers\ndegree 1 or 2 for stepper on M1 or M2. May move simutaniously\n"),
    _("robotbit.servo(index, degree) \nServo degree\nindex: 0~7 for S1 to S8 on robotbit\ndegree: 0~180"),
    _("robotbit.sonar(pin) \nUltrasonic Sensor\npin: pin0 to pin2 for microbit"),
